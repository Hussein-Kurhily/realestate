...
return new class extends Migration
{
    ...
    {
        Schema::create('rent_realestate_table', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('rent_realestate_table', function (Blueprint $table) {
        $table->dropForeign(['user_id']);
    });
        Schema::dropIfExists('rent_realestate_table');
